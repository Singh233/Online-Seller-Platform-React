  ...
  return (
    <div className={` ${styles.container} animate__animated animate__fadeIn`}>
      <div className={styles.overlay}>
        ...
        <div
          className={`animate__animated ${styles.descriptionOverlay} ${
            !showDescription ? " animate__flipOutX" : " animate__flipInX"
          } ${!hide ? styles.hide : ""}`}
        >
        ...
        <div className={styles.seeDetailsButton}>
          <p>
            See Details &nbsp;
            <FontAwesomeIcon
              icon={!showDescription ? faChevronDown : faChevronUp}
              className={`animate__animated  ${
                showDescription ? "animate__flipInX" : ""
              } `}
            />
          </p>
        </div>
